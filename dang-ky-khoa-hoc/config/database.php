<?php
/**
 * File kết nối cơ sở dữ liệu bằng PDO
 * Đồ án: Website Đăng ký khóa học
 *
 * Mỗi thành viên khi chạy code trên máy mình chỉ cần chỉnh lại
 * DB_HOST, DB_NAME, DB_USER, DB_PASS cho đúng với XAMPP/Laragon của mình.
 */
